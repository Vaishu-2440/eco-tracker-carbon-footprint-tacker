...
Train model: ..venv\Scripts\python src\train_model.py
...
🎯 How to Use
Create Profile - Start by creating your user profile
Log Daily Activities - Input your transportation, energy, food, and waste data
View Dashboard - Monitor your emissions with interactive charts
Get AI Predictions - Use ML models to predict your annual footprint
Analyze Patterns - Explore advanced analytics to understand your habits
Set Goals - Create reduction targets and track progress
Follow Recommendations - Implement AI-generated suggestions
🤖 AI Models
...
Verify the database permissions in the data/ directory
